const products = [
  ...
  },
  {
    ...
    price: 22.3,
    description:
      "Slim-fitting style, contrast raglan long sleeve, three-button henley placket, light weight & soft fabric for breathable and comfortable wearing.  The Henley style round neckline includes a three-button placket.",
    category: "Mens",
    image:
  ...
  },
  {
    ...
    price: 10.99,
    description:
      "Rose Gold Plated Double Flared Tunnel Plug Accessories. Made of 316L Stainless Steel",
    category: "Accessories",
  ...
  },
  {
    ...
    price: 599,
    description:
      "21. 5 inches Full HD (1920 x 1080) widescreen IPS display And Radeon free Sync technology. No compatibility for VESA Mount Refresh Rate: 75Hz - Using HDMI port Zero-frame design |IPS panel Aspect ratio - 16: 9.",
    category: "Electronics",
  ...
  {
    id: 16,
    title: "Lock  Women's Removable Hooded Leather  Biker Jacket",
    price: 29.95,
    description:
  ...
  },
  {
    ...
    price: 360,
    description:
      "You will be comfortable from the first call to the last thanks to the re-engineered leatherette ear cushion design that allows for better airflow. ",
    category: "Electronics",
